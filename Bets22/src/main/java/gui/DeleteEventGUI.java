...
public class DeleteEventGUI extends JFrame {
	...
	private JButton btnDeleteEvent = new JButton(ResourceBundle.getBundle("Etiquetas").getString("DeleteEvent"));
	...
	public DeleteEventGUI(String userName, String language) {
		myScreen = this;
		try {
	...
	private void jbInit(String userName, String language) throws Exception {
		...
		Vector<domain.Event> v  = facade1.getAllEvents();
		...
		btnDeleteEvent.setBounds(new Rectangle(209, 277, 185, 30));
		...
		jButtonClose.setBounds(new Rectangle(437, 277, 130, 30));
		...
		jButtonBack.setBounds(new Rectangle(35, 277, 130, 30));
		...
		jLabelError.setBounds(new Rectangle(213, 241, 305, 20));
		...
		this.getContentPane().add(btnDeleteEvent, null);
...
//			    		  Component o=(Component) jCalendar.getDayChooser().getDayPanel().getComponent(i+offset);; 
	...
	private void jButtonCreate_actionPerformed(ActionEvent e,String userName, String language) {
		...
		try {
			...
			f.removeEvent(event.getEventNumber());
